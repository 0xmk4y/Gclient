    ...
    <div className='flex'>
        ...
        <div className='flex flex-col w-full p-3'>
            ...
            <div className='flex flex-col justify-center items-center w-full'>
                ...
                <form action="" className='text-sm w-full md:max-w-[500px] p-3 bg-white text-gray-400'>
                    <div className='flex flex-col md:flex-row gap-2'>
                        <div className='flex items-center border dark:border-gray-500 border-b-2 border-b-primary mb-8 bg-gray-100'>
                            ...
                            <input type="text" placeholder='FirstName' className='p-2 w-full focus:ring-0 outline-none bg-transparent text-black' />
                        </div>
                        <div className='flex items-center border dark:border-gray-500 border-b-2 border-b-primary mb-8 bg-gray-100'>
                            <User className='mx-1 dark:text-primary' />
                            <input type="text" placeholder='LastName' className='p-2 w-full focus:ring-0 outline-none bg-transparent text-black' />
                        </div>
                    </div>
                    <div className='flex items-center border dark:border-gray-500 border-b-2 border-b-primary mb-8 bg-gray-100'>
                    ...
                    <div className='flex flex-col md:flex-row gap-2'>
                        ...
                        <div className='flex items-center border dark:border-gray-500 border-b-2 border-b-primary mb-8 bg-gray-100'>
                            <Lock className='mx-1 dark:text-primary' />
                            <input type="password" placeholder='Confirm password' className='p-2 w-full focus:ring-0 outline-none bg-transparent text-black' />
                        </div>
                    </div>
                    <div className='flex items-center border dark:border-gray-500 border-b-2 border-b-primary mb-8 bg-gray-100'>
                        <Phone className='mx-1 dark:text-primary' />
                        <input type="text" placeholder='Contact' className='p-2 w-full focus:ring-0 outline-none bg-transparent text-black' />
                    </div>
